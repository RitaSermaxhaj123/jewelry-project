...
<html lang="en">
  <head>
    ...
    <title>Categories -  Earrings</title>
    <style>
      .sidenav {
        height: 100%;
        width: 160px;
...
<div class="sidenav">
  <div class="content">
  <a href="earrings.php" class="actived">Earrings</a>
      ...
      <div class="card">
       <img src="<?php echo $rows['image']; ?>" class="card-img-top img-jew" alt="..."/>
        <div class="card-body">
          ...
          <a name="btnBuy" href="buy.php?prodId=<?php echo $rows['prodId']; ?> & name=<?php echo $rows['name']; ?> & price=<?php echo $rows['price']; ?> & image=<?php echo $rows['image']?> & count=<?php echo $rows['count'] ?>"  class="btn btn-success butoni">Buy</a>
          <a href="#" class="add-card btn wishlista"><i class="fas fa-heart"></i></a>
          <?php
          if($rows['count'] == 0){
        echo "<script type='text/javascript'>";
        echo "document.getElementByName('btnBuy').setAttribute('class','disabled')";
        echo "</script>";
    }
    ?>
        </div>
