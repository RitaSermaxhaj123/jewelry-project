...
<html lang="en">
  <head>
    ...
    <title>Categories -  Bracelet</title>
    <style>
      .sidenav {
        height: 100%;
        width: 160px;
...
<div class="sidenav">
  ...
  <a href="brace.php" class="actived">Bracelets</a>
      ...
      <div class="card">
       <img src="<?php echo $rows['image']; ?>" class="card-img-top img-jew" alt="..."/>
        ...
        <p><?php $rows['count'];?></p>
          ...
          <a href="" class="add-card btn wishlista" name="wish"><i class="fas fa-heart"></i></a>
        </div>
      </div>
      </form>
    </div> 
